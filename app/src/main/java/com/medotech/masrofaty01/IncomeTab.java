...
public class IncomeTab extends CategoryTab {
    ...
    public void updateCategory(int position) {
        ...
        intent.putExtra("categoryMoney", categoryList.get(position).getMoney());
    ...
    public void viewItems(int position) {
        ...
        intent.putExtra("categoryType", "INCOME");
        getActivity().startActivity(intent);
        getActivity().finish();
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.update_menu_item:
                Toast.makeText(getActivity().getApplicationContext(),"update: " + categoryList.get(item.getGroupId()).getName() ,Toast.LENGTH_LONG).show();
                break;
            case R.id.delete_menu_item:
                Toast.makeText(getActivity().getApplicationContext(),"delete: " + categoryList.get(item.getGroupId()).getName() ,Toast.LENGTH_LONG).show();
                break;
        }
